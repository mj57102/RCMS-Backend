...
{
    /// <summary>موجودیت «عضو هیئت‌مدیره» - شامل فیلدهای پایه و چندزبانه</summary>
    public class BoardMember
    {
        [Display(Name="عضو هیئت‌مدیره - شناسه")] public long Id { get; set; }
        [Required, MaxLength(200), Display(Name="عضو هیئت‌مدیره - عنوان")] public string Title { get; set; } = string.Empty;
        [MaxLength(200), Display(Name="عضو هیئت‌مدیره - عنوان (EN)")] public string? TitleEn { get; set; }
        [MaxLength(1000), Display(Name="عضو هیئت‌مدیره - توضیحات")] public string? Description { get; set; }

...
{
    /// <summary>موجودیت «آیتم صورتحساب» - شامل فیلدهای پایه و چندزبانه</summary>
    public class InvoiceItem
    {
        [Display(Name="آیتم صورتحساب - شناسه")] public long Id { get; set; }
        [Required, MaxLength(200), Display(Name="آیتم صورتحساب - عنوان")] public string Title { get; set; } = string.Empty;
        [MaxLength(200), Display(Name="آیتم صورتحساب - عنوان (EN)")] public string? TitleEn { get; set; }
        [MaxLength(1000), Display(Name="آیتم صورتحساب - توضیحات")] public string? Description { get; set; }

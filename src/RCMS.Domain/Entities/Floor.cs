...
{
    /// <summary>موجودیت «طبقه» - شامل فیلدهای پایه و چندزبانه</summary>
    public class Floor
    {
        [Display(Name="طبقه - شناسه")] public long Id { get; set; }
        [Required, MaxLength(200), Display(Name="طبقه - عنوان")] public string Title { get; set; } = string.Empty;
        [MaxLength(200), Display(Name="طبقه - عنوان (EN)")] public string? TitleEn { get; set; }
        [MaxLength(1000), Display(Name="طبقه - توضیحات")] public string? Description { get; set; }

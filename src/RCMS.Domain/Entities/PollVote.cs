...
{
    /// <summary>موجودیت «رأی» - شامل فیلدهای پایه و چندزبانه</summary>
    public class PollVote
    {
        [Display(Name="رأی - شناسه")] public long Id { get; set; }
        [Required, MaxLength(200), Display(Name="رأی - عنوان")] public string Title { get; set; } = string.Empty;
        [MaxLength(200), Display(Name="رأی - عنوان (EN)")] public string? TitleEn { get; set; }
        [MaxLength(1000), Display(Name="رأی - توضیحات")] public string? Description { get; set; }

...
{
    /// <summary>موجودیت «کاربر» - شامل فیلدهای پایه و چندزبانه</summary>
    public class User
    {
        [Display(Name="کاربر - شناسه")] public long Id { get; set; }
        [Required, MaxLength(200), Display(Name="کاربر - عنوان")] public string Title { get; set; } = string.Empty;
        [MaxLength(200), Display(Name="کاربر - عنوان (EN)")] public string? TitleEn { get; set; }
        [MaxLength(1000), Display(Name="کاربر - توضیحات")] public string? Description { get; set; }

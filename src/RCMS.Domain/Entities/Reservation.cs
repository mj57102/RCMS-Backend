...
{
    /// <summary>موجودیت «رزرو» - شامل فیلدهای پایه و چندزبانه</summary>
    public class Reservation
    {
        [Display(Name="رزرو - شناسه")] public long Id { get; set; }
        [Required, MaxLength(200), Display(Name="رزرو - عنوان")] public string Title { get; set; } = string.Empty;
        [MaxLength(200), Display(Name="رزرو - عنوان (EN)")] public string? TitleEn { get; set; }
        [MaxLength(1000), Display(Name="رزرو - توضیحات")] public string? Description { get; set; }

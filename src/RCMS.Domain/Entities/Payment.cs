...
{
    /// <summary>موجودیت «پرداخت» - شامل فیلدهای پایه و چندزبانه</summary>
    public class Payment
    {
        [Display(Name="پرداخت - شناسه")] public long Id { get; set; }
        [Required, MaxLength(200), Display(Name="پرداخت - عنوان")] public string Title { get; set; } = string.Empty;
        [MaxLength(200), Display(Name="پرداخت - عنوان (EN)")] public string? TitleEn { get; set; }
        [MaxLength(1000), Display(Name="پرداخت - توضیحات")] public string? Description { get; set; }

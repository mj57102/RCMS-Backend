...
{
    /// <summary>موجودیت «تراکنش کیف پول» - شامل فیلدهای پایه و چندزبانه</summary>
    public class WalletTransaction
    {
        [Display(Name="تراکنش کیف پول - شناسه")] public long Id { get; set; }
        [Required, MaxLength(200), Display(Name="تراکنش کیف پول - عنوان")] public string Title { get; set; } = string.Empty;
        [MaxLength(200), Display(Name="تراکنش کیف پول - عنوان (EN)")] public string? TitleEn { get; set; }
        [MaxLength(1000), Display(Name="تراکنش کیف پول - توضیحات")] public string? Description { get; set; }

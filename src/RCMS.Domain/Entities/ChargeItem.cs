...
{
    /// <summary>موجودیت «آیتم شارژ» - شامل فیلدهای پایه و چندزبانه</summary>
    public class ChargeItem
    {
        [Display(Name="آیتم شارژ - شناسه")] public long Id { get; set; }
        [Required, MaxLength(200), Display(Name="آیتم شارژ - عنوان")] public string Title { get; set; } = string.Empty;
        [MaxLength(200), Display(Name="آیتم شارژ - عنوان (EN)")] public string? TitleEn { get; set; }
        [MaxLength(1000), Display(Name="آیتم شارژ - توضیحات")] public string? Description { get; set; }
